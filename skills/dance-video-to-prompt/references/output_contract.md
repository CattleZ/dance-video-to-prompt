...
1. `## 视觉风格` — 画质、构图、光影、色调  
2. `## 场景叙述` — 人物（含 **身材体型特征**）、服装、环境、氛围（可写整体表情气质）  
3. `## 摄影技术` — **拍摄方法、运镜、关注重点**、机位、焦段、灯光、情绪  
...
**最低要求**：至少写出「整体体型 + 腰腿/肩胯中 ≥2 项可见细节 + 体态」；全身出镜时尽量 4 项以上。

示例（结构示意，勿照抄）：

> 一位身材高挑纤细的年轻女性，头身比修长，腿长占比明显，窄肩、锁骨清晰，腰肢纤细、小腹平坦，胯线利落，细长直腿，手臂纤细，站姿挺拔略带舞蹈感；……（发型服装环境）
...
- [ ] 未编造画面没有的关键内容（含不可见的身材部位、看不出的专业器材）  
